...
<div class="login-box" style="margin-top: 100px;">
  <h2>물건 등록</h2>
  <form method="POST" enctype="multipart/form-data" action="product-add-action.jsp">
    <div class="user-box">
      <input type="text" name="productName" required autofocus autocomplete="off">
      <label>productName</label>
    </div>
    
    <div class="user-box">
      <input type="number" name="productPrice" required autocomplete="off">
      <label>productPrice</label>
    </div>
    
    <div class="user-box">
      <input type="hidden" name="productDate" required autocomplete="off">
      <label>productPrice</label>
    </div>
    ...
    <div class="user-box">
      <textarea rows="15" cols="40" name="productText" placeholder="물건 상세 내용"></textarea>
    </div>
